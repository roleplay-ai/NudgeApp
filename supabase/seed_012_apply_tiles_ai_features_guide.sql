-- ============================================
-- Seed apply_tiles from AI_Features_Guide (same copy as seed_011)
-- ============================================
-- Top "What can AI do?" grid. Run after migration_010 / migration_011 (estimated_duration).
-- Walkthrough duplicates: seed_011 rows are is_published = false — publish in Admin if you want clips below.
-- Safe re-run: DELETE rows with tile seed marker in what_it_does, then INSERT.
-- ============================================

DELETE FROM public.apply_tiles
WHERE what_it_does LIKE '%[seed:ai-features-guide-tiles-v1]%';

INSERT INTO public.apply_tiles
...
(
  'Design infographics',
  'Turn data or concepts into shareable visuals',
  'Workflows',
  false,
  0,
  '#A855F7',
...
[seed:ai-features-guide-tiles-v1]',
  'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4',
  '[{"name":"Gemini","color":"#4285F4"},{"name":"Copilot","color":"#0078D4"},{"name":"ChatGPT","color":"#23CE68"},{"name":"Claude","color":"#D97757"}]'::jsonb,
  '~1 min'
),
(
  'Design dashboards',
  'Build a live data view without a developer',
  'Workflows',
  false,
  1,
  '#EC4899',
...
(
  'AI browsers',
  'A browser that takes actions, not just searches',
  'Apps',
  false,
  2,
  '#F59E0B',
...
[seed:ai-features-guide-tiles-v1]',
  ...
  '[{"name":"Comet (Perplexity)","color":"#8B5CF6"},{"name":"Operator/Atlas (OpenAI)","color":"#10A37F"}]'::jsonb,
  '~1 min'
),
(
  'Design slides (PPT)',
  'From a topic to a full deck in minutes',
  'Workflows',
  false,
  3,
  '#3B82F6',
...
(
  ...
  'Build AI that completes multi-step tasks without you',
  'Skills',
  false,
  5,
  '#ED4551',
...
[seed:ai-features-guide-tiles-v1]',
  ...
  '[{"name":"Google AI Studio","color":"#FBBC04"},{"name":"Copilot Studio","color":"#0078D4"}]'::jsonb,
  '~1 min'
),
(
  'Vibe coding',
  'Build working software by describing it in plain English',
  'Skills',
  false,
  6,
  '#A855F7',
...
[seed:ai-features-guide-tiles-v1]',
  ...
  '[{"name":"Codex (OpenAI)","color":"#10A37F"},{"name":"Claude Code","color":"#D97757"},{"name":"Google AI Studio","color":"#FBBC04"}]'::jsonb,
  '~1 min'
),
(
  'Canvas',
  'Edit AI replies inline - surgically',
  'Features',
  false,
  7,
  '#EC4899',
...
[seed:ai-features-guide-tiles-v1]',
  ...
  '[{"name":"ChatGPT","color":"#23CE68"},{"name":"Claude","color":"#D97757"},{"name":"Gemini","color":"#4285F4"}]'::jsonb,
  '~1 min'
),
(
  'Notebook',
  'AI answers grounded in your sources, not the internet',
  'Features',
  false,
  8,
  '#F59E0B',
...
[seed:ai-features-guide-tiles-v1]',
  ...
  '[{"name":"Gemini","color":"#4285F4"},{"name":"Copilot","color":"#0078D4"}]'::jsonb,
  '~1 min'
),
(
  'Projects',
  'One persistent workspace for ongoing work',
  'Features',
  false,
  9,
  '#3B82F6',
...
[seed:ai-features-guide-tiles-v1]',
  ...
  '[{"name":"Copilot","color":"#0078D4"},{"name":"ChatGPT","color":"#23CE68"},{"name":"Claude","color":"#D97757"}]'::jsonb,
  '~1 min'
),
(
  'Connect apps',
  'Let AI read your actual work data',
  'Features',
  false,
  10,
  '#23CE68',
...
(
  'Memories',
  'AI that learns who you are over time',
  'Features',
  false,
  12,
  '#A855F7',
...
(
  'Thinking models',
  'AI that reasons before it answers',
  'Features',
  false,
  14,
  '#F59E0B',
...
(
  'Design images',
  'Generate visuals from a text prompt',
  'Workflows',
  false,
  15,
  '#3B82F6',
...
[seed:ai-features-guide-tiles-v1]',
  'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4',
  '[{"name":"Gemini","color":"#4285F4"},{"name":"Copilot","color":"#0078D4"},{"name":"ChatGPT","color":"#23CE68"}]'::jsonb,
  '~1 min'
),
(
  'Deep research',
  'AI that researches like an analyst, not a search engine',
  'Features',
  false,
  16,
  '#23CE68',
...
(
  'Scheduled actions',
  'AI that works even when you''re not there',
  'Features',
  false,
  17,
  '#ED4551',
...
(
  'Design videos',
  'Turn a text prompt into a short video',
  'Workflows',
  false,
  18,
  '#A855F7',
...
[seed:ai-features-guide-tiles-v1]',
  ...
  '[{"name":"Gemini","color":"#4285F4"}]'::jsonb,
  '~1 min'
),
(
  'AI in Excel',
  'Your data analyst, sitting inside your spreadsheet',
  'Features',
  false,
  19,
  '#EC4899',
...
(
  ...
  'Build a bot so you never type the same prompt again',
  'Features',
  false,
  20,
  '#F59E0B',
