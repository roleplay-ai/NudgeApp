/** Format seconds as M:SS or H:MM:SS for display (matches existing UI examples like "2:30"). */
...
/** Read duration from a local video file using browser metadata (no upload). */
